...
class _SelectNearestActiveDriversScreenState extends State<SelectNearestActiveDriversScreen>
{
  ...
  getFareAmountAccordingToVehicleType(int index) {
    if (tripDirectionDetailsInfo != null) {
      double distance = AssistantMethods.calculateFareAmountFromOriginToDestination(tripDirectionDetailsInfo!);

      // Calculate fare as 10 Rs per kilometer
      fareAmount = (distance * 10).toStringAsFixed(1);
    }
    return fareAmount;
  }
