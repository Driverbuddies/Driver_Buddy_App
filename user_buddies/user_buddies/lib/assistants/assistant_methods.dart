...
import 'package:user_buddies/assistants/request_assistant.dart';
import 'package:user_buddies/key/global.dart';
import 'package:user_buddies/key/const.dart';
import 'package:user_buddies/infoHandler/app_info.dart';
import 'package:user_buddies/models/direction_details_info.dart';
import 'package:user_buddies/models/directions.dart';
import 'package:user_buddies/models/trips_history_model.dart';
...
class AssistantMethods
{
  ...
  static void readTripsKeysForOnlineUser(context)
  {
    FirebaseDatabase.instance.ref()
        ...
        .equalTo("${userModelCurrentInfo!.firstName} ${userModelCurrentInfo!.lastName}")
        .once()
        .then((snap)
    {
      if(snap.snapshot.value != null)
