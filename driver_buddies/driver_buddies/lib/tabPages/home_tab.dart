...
import 'package:driver_buddies/main.dart';
import '../push_notifications/push_notification_system.dart';
import 'package:driver_buddies/splashScreen/splash_screen.dart';
...
class _HomeTabPageState extends State<HomeTabPage>
{
  ...
  static const CameraPosition _kIndiaCenter = CameraPosition(
    target: LatLng(22.3511, 78.6677), // Coordinates for the center of India
  ...
  readCurrentDriverInformation() async
  {
        ...
        .then((DatabaseEvent snap)
    {
      if(snap.snapshot.value != null)
      {
        ...
        onlineDriverData.phoneNumber = (snap.snapshot.value as Map)["phoneNumber"];
